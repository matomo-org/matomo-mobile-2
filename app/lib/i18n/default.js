...
module.exports = {
    ...
    Mobile_RestrictedCompatiblity:                                      'Restricted comptability',
    Mobile_RestrictedCompatiblityExplanation:                           'The Piwik version %s you are using is not fully supported by Piwik Mobile 2. You may experience some bugs. We recommend to either update Piwik to the latest version or to use Piwik Mobile 1.',
